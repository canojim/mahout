...
public class PredictionMapper
	...
	@Override
	Pair<OpenIntObjectHashMap<Vector>, OpenIntObjectHashMap<Vector>> createSharedInstance(
			Context ctx) {
		 ...
		 * 
		 * return new Pair<OpenIntObjectHashMap<Vector>,
		 * OpenIntObjectHashMap<Vector>>( U, M);
		 */}
	...
	protected void setup(Context ctx) throws IOException, InterruptedException {
		...
		pathToU = new Path(conf.get(RecommenderJob.USER_FEATURES_PATH));
	...
	private HashSet<Long> loadFilterList(Configuration conf)
			throws IOException {
